...
lines.push("// Quelle: Bagel Factory 'Full Ingredient List' PDF (Issue 20, 13/04/2026) · " + items.length + " Items · per-portion, Werte = Plain Bun.");
lines.push("// NUR Set-Menue: EXTRAS/SAUCES der PDF sind per-100g ohne Portionsgroessen -> BYO/Customizing nicht abbildbar.");
